...
export default function CreditHistorySection({
  ...
  const cardClass = "bg-white border border-blue-100 shadow-sm rounded-2xl p-5 md:p-6";
    ...
    <div className="w-full max-w-6xl mx-auto px-4 py-6 md:py-10 text-slate-800">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-slate-500">Comprehensive credit score analysis and trends</p>
        </div>
      ...
      <div className={`${cardClass} mt-6`}>
        <div className="mb-4 flex items-baseline justify-between">
          ...
          <p className="text-sm text-slate-500">Active accounts overview</p>
        </div>
