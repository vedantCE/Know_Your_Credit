...
const Index = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Detailed breakdown of your credit report with explanations of each factor affecting your score",
    },
    {
    ...
    },
    {
      ...
      description:
        "Personalized recommendations to improve your credit score effectively",
    },
    {
      icon: <Shield className="h-8 w-8 text-blue-600" />,
    ...
    },
    {
      ...
      description:
        "Continuous tracking of your credit profile with monthly updates",
    },
  ];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-gray-200 shadow-lg">
              ...
              <p className="text-gray-600">
                We aggregate and normalize data from multiple credit bureaus
              </p>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-gray-200 shadow-lg">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl font-bold">
